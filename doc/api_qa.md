...
> 建议：输入文本不要含空格、回车换行、制表符等。背景知识字数最好不大于500，问题字数不要大于100。


请求URL

> http://127.0.0.1:5000/api/albert_qa
...
```json
{
    "data": {
        "msg": "success",
        "answer": "建筑学上是指锥体建筑物",
        "requestId": "210629151110345e56759dbd0e74374e67f2225b7f1b"
    },
}
```
